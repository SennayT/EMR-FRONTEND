...
export default function ChartEight(props: any) {
  ...
  return (
    ...
    <div>
      ...
      {data['by_age'] ? <ReactApexChart options={option_age} series={series_age} type='pie' width='500px' /> : <div></div>}
      {data['by_gender'] ?


        <ReactApexChart options={option_gender} series={series_gender} type='pie' width='640px' /> : <div></div>}
    </div>
  )
};
