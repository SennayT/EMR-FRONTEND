...
export default function ChartEight(props: any) {
  ...
  useEffect(() => {
    ...
    requests
      .post('researcher/medication', body, session ? session.accessToken.toString() : '')
  ...
  const option_gender = {
    labels: [
      'Prescriptions with the specified medication and with in the age group',
      'Patients with the specified gender'
    ]
  }
